<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-center text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('ECG - Your Trusted Multi-Vendor Marketplace') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <img src="{{ asset('logo2.png') }}" alt="ECG Logo" class="mx-auto mb-4" style="width: 1000px; height: 200px;">
                    <h3 class="text-center font-bold mb-4" style="font-size: 24px;">{{ __('Welcome to ECG!') }}</h3>
                    <p class="text-center" style="font-size: 20px;">{{ __("We're excited to welcome you to ECG, where innovation meets opportunity. Whether you're here to discover top-quality products, grow your business, or connect with a diverse community of trusted vendors and buyers, you’ve come to the right place.") }}</p>
                    <br></br>
                    <p class="text-center" style="font-size: 20px;">{{ __("Our platform brings together a vibrant ecosystem of sellers from various industries, offering everything from everyday essentials to unique, hard-to-find items. We’re committed to ensuring a seamless, secure, and rewarding experience for every user—whether you're making your first purchase or launching your next storefront.") }}</p>
                    <br></br>
                    <p class="text-center" style="font-size: 20px;">{{ __("At ECG, we prioritize quality, transparency, and customer satisfaction. Our tools and support systems are designed to help vendors thrive and customers shop with confidence. From intuitive dashboards to responsive customer service, every aspect of our platform is built with you in mind.") }}</p>
                    <br></br>
                    <p class="text-center font-bold" style="font-size: 24px;">{{ __("Explore. Connect. Grow.") }}</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if ($randomProducts->isEmpty())
                        <p class="text-center text-gray-500">{{ __('No products available at the moment.') }}</p>
                    @else
                            ...
                            <div class="border rounded-lg p-4 flex flex-col bg-white shadow-md">
                                ...
                                <div class="flex flex-col w-full mt-4">
                                    <div class="flex justify-between items-center mb-1">
                                        <p class="font-bold product-name text-lg" style="overflow: hidden; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical;">{{ $product->name }}</p>
                                        <p class="bg-blue-200 text-black px-2 rounded border border-black text-xs">{{ $product->product_types_name }}</p>
                                    </div>
                                    <p class="text-gray-700 mb-1 line-clamp-2" style="overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">
                                        {{ $product->description }}
                                    </p>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <ul>
                                    ...
                                    <li class="mb-6 p-4 rounded-lg"
                                        ...
                                        <div class="flex items-center justify-between mt-4">
                                            <p class="text-gray-700" style="font-size: 12px; font-weight: bold; text-align: left;">
                                                Total Products: {{ $totalProductsForVendor }}
                                            </p>
                                ...
                                @else
                                    <p class="text-center text-gray-500">{{ __('No vendors available at the moment.') }}</p>
                                @endif
                            </ul>
                        </div>
                    </div>
